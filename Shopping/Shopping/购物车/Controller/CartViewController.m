...
- (void)viewDidLoad{
    ...
    UITableView *tabelView = [[UITableView alloc]initWithFrame:CGRectMake(0, 64, MainW, MainH-64 - 44 - 44)];
...
- (void)initDownView{
    _downView = [[UIView alloc]initWithFrame:CGRectMake(0, MainH - 43.5 - 44, MainW, 43.5)];
