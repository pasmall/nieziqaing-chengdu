...
-(void)setNav{
    UIView *backView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, MainW, 64)];
    backView.backgroundColor = RGB(250, 250, 250);
    [self.view addSubview:backView];
    //下划线
    UIView *lineView = [[UIView alloc] initWithFrame:CGRectMake(0, 63.5, MainW, 0.5)];
    ...
    //标题
    _titleLabel = [[UILabel alloc] initWithFrame:CGRectMake(MainW/2-80, 30, 160, 30)];
...
-(void)initViews{
    self.tableView = [[UITableView alloc] initWithFrame:CGRectMake(0, 64, MainW, MainH-64) style:UITableViewStyleGrouped];
...
-(UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section{
    UIView *headerView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, MainW , 10)];
    headerView.backgroundColor = RGB(239, 239, 244);
    //    headerView.backgroundColor = [UIColor redColor];
    return headerView;
}
-(UIView *)tableView:(UITableView *)tableView viewForFooterInSection:(NSInteger)section{
    UIView *footerView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, MainW, 0)];
