...
-(void)initViews{
    ...
    //店名
    self.shopNameLabel = [[UILabel alloc] initWithFrame:CGRectMake(100, 5, MainW-100-80, 30)];
    [self.contentView addSubview:self.shopNameLabel];
    
    //介绍
    self.shopInfoLabel = [[UILabel alloc] initWithFrame:CGRectMake(100, 30, MainW-100-10, 45)];
    ...
    self.priceLabel.textColor = RGB(33, 192, 174);
