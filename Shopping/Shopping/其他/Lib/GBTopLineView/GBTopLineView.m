...
- (void)createCurrentView
{
    ...
    self.currentBtn.frame = CGRectMake(10, 5, 40, self.currentView.frame.size.height-10);
...
- (void)createHidenView
{
    ...
    self.hidenBtn.frame = CGRectMake(10, 5, 40, self.hidenView.frame.size.height - 10);
